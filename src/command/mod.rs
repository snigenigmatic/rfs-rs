...
fn handle_set(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.len() < 2 {
...
fn handle_del(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.is_empty() {
...
fn handle_lpush(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.len() < 2 {
...
fn handle_rpush(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.len() < 2 {
...
fn handle_lpop(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
...
fn handle_rpop(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.is_empty() || args.len() > 2 {
...
fn handle_sadd(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.len() < 2 {
...
fn handle_srem(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.len() < 2 {
...
fn handle_hset(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
...
fn handle_zrange(args: Vec<RespFrame>, store: &SharedStore) -> RespFrame {
    if args.len() < 3 {
...
fn handle_zscore(args: Vec<RespFrame>, store: &SharedStore) -> RespFrame {
    if args.len() != 2 {
...
fn handle_zrank(args: Vec<RespFrame>, store: &SharedStore) -> RespFrame {
    if args.len() != 2 {
...
fn handle_zcard(args: Vec<RespFrame>, store: &SharedStore) -> RespFrame {
    if args.len() != 1 {
...
fn handle_zrem(args: Vec<RespFrame>, store: &SharedStore, aof: Option<&AofWriter>) -> RespFrame {
    if args.len() < 2 {
...
fn handle_zcount(args: Vec<RespFrame>, store: &SharedStore) -> RespFrame {
    if args.len() != 3 {
